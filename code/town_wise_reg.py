...
sales = df.iloc[:,11:-1] #Excluding Total Sale
others = df.iloc[:,1:11]
orginal_data = df.iloc[:,[2,8,9]] #Population, avg CPI, area, town/city
...
orginal_data.columns = ['total population', 'Avg. CPI for the Period', 'Area (km2)']
